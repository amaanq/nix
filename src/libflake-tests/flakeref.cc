...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        InputFromURLTestCase{
            .url = "_1password-shell-plugins",
            .attrs =
                {
                    {"id", Attr("_1password-shell-plugins")},
                    {"type", Attr("indirect")},
                },
            .description = "underscore_digit_prefixed_flake_id",
            .expectedUrl = "flake:_1password-shell-plugins",
        },
        InputFromURLTestCase{
...
TEST(parseInputAttrPath, underscorePrefixed)
{
    ...
    auto path2 = flake::parseInputAttrPath("_1password-shell-plugins/nested");
    ASSERT_EQ(path2.size(), 2);
    ASSERT_EQ(path2[0], "_1password-shell-plugins");
